...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.caption_label.setToolTip(QCoreApplication.translate("sub_dataset_input", u"<html><head/><body><p>Tag Extension is how you tell sd-scripts if your tag files are .txt or .caption. All tags should be delimited by commas.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.caption_label.setText(QCoreApplication.translate("sub_dataset_input", u"Tag Extension", None))
...
#if QT_CONFIG(tooltip)
        self.caption_extension_selector.setToolTip(QCoreApplication.translate("sub_dataset_input", u"<html><head/><body><p>Tag Extension is how you tell sd-scripts if your tag files are .txt or .caption. All tags should be delimited by commas.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        CONFIG(tooltip)
        self.caption_label.setToolTip(QCoreApplication.translate("sub_dataset_input", u"<html><head/><body><p>Caption Extension is how you tell sd-scripts if your caption files are .txt or .caption; the entire contents will be passed into the tokenizer unless the Sentence Split field is enabled</p></body></html>", None))
        # endif // QT_CONFIG(tooltip)
        self.caption_label.setText(QCoreApplication.translate("sub_dataset_input", u"Caption Extension", None))
        self.caption_extension_selector.setItemText(0, QCoreApplication.translate("sub_dataset_input", u".txt", None))
        self.caption_extension_selector.setItemText(1, QCoreApplication.translate("sub_dataset_input", u".caption", None))
        # if QT_CONFIG(tooltip)
        self.caption_extension_selector.setToolTip(QCoreApplication.translate("sub_dataset_input", u"<html><head/><body><p>Caption Extension is how you tell sd-scripts if your caption files are .txt or .caption; the entire contents will be passed into the tokenizer unless the Sentence Split field is enabled</p></body></html>", None))
        # endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
